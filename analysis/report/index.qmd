...
cat("============================\n")
cat("• Sample size: Limited to", nrow(penguins_clean), "penguins (2007-2009)\n")
cat("• Geographic scope: Palmer Station region only\n")
cat("• Temporal constraints: Three-year observation window\n")
cat("• Species balance: Unequal representation across species\n")
cat("• Measurement precision: Field measurement uncertainties\n")
cat("• Model assumptions: Linearity within species groups\n")
...
Our rigorous cross-validation confirms that linear models with species information achieve excellent predictive performance (R² ≈ 0.86) while maintaining interpretability. Polynomial features and random forests offer minimal improvements, suggesting biological relationships are well-captured by linear terms within species.
